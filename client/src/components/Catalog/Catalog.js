        ...
        <section className="catalog">
            ...
            <div className="container">
                ...
                <div className="introduction-container hidden">
                    ...
                    <NavLink className="explore-btn hidden" to="/products/page/1">Explore our collections</NavLink>
                </div>
                ...
                <div className="resell-container hidden">
                    ...
                    <p className='hidden'></p>
                    <NavLink className="sell-btn hidden" to="/recycle/page/1">Retail your old furniture</NavLink>
                </div>
